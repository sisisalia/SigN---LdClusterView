function getData(update) {
    ...
    if(update == 1){
        // data = update_data(data, save_data);
	...
	data.snp_order = $.map(data.snps, function(snp, id) {
	    return id;
	});
	...
	$("#window_size_select").val(data.windowSize);
}
